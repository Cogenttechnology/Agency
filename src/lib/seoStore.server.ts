...
const DEFAULT_PAGES: PageSeo[] = [
  ...
  },
  {
    ...
    schemas: [{ type: 'WebPage', enabled: true, custom: webPageSchema('Our Work & Client Results — Cogent Agency', 'https://cogent.agency/portfolio', 'Cogent Agency has helped clients across healthcare, hospitality, fashion, finance, and FMCG rank on page 1 of Google. Explore real SEO results and case studies.') }],
    updatedAt: new Date().toISOString(),
  },
  {
